<template>
    <div>
      ...
      <section class="result-aggregate">
           <div class="switch">
               同一結果をまとめる&nbsp;
               <input id="cmn-aggregate" class="cmn-toggle" type="checkbox" v-model="aggregated">
               <label for="cmn-aggregate"></label>
           </div>
      </section>
            ...
            <main class="content__main">
                ...
                <ul class="result">
                    <template v-if="aggregated">
                        <template v-for="(ds, index) in series">
...
export default class IndexPage extends Vue {
    ...
    get series(): Array<Array<Dataset>> {
        return datasetStore.series
    }

    get selectedSeries(): Series {
        if (this.aggregationIndex !== null) {
            return new Series(this.series[this.aggregationIndex])
        } else {
            return new Series([])
        }
    }
